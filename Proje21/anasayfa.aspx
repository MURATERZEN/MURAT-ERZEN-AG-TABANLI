<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="anasayfa.aspx.vb" Inherits="Proje21.anasayfa" %>
...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbars-rs-food">
					<ul class="navbar-nav ml-auto">
						<li class="nav-item active"><a class="nav-link" href="anasayfa.aspx">Anasayfa</a></li>
	...
	<div > id="slides" class="cover-slides">
		<ul ></ul> class="slides-container">
			<li class="text-center ">
				<img src="yamifood/images/slider-01.jpg" alt="">
				<div class="container">
					<div class="row">
						<div  class="col-md-12 "
							<h1 class="m-b-20"><strong>HOŞ GELDİNİZ <br> 1 ERKEK 1 MUTFAK </strong></h1>
							<p class="m-b-40">Bizimle bu güzel lezzetleri tatmak ve doyuruculuğuna varmak için  <br> 
							Rezervasyon yapınız.</p>
							<p><a class="btn btn-lg btn-circle btn-outline-new-black" href="iletisim.aspx">Rezervasyon</a></p>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						...
						<asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" EmptyDataText="Görüntülenecek hiç veri kaydı yok." Width="479px">
                            <Columns>
                                <asp:BoundField DataField="anasayfa" HeaderText="anasayfa" SortExpression="anasayfa" />
                            </Columns>
                        </asp:GridView>
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:restoranConnectionString1 %>" ProviderName="<%$ ConnectionStrings:restoranConnectionString1.ProviderName %>" SelectCommand="SELECT [anasayfa] FROM [sayfalar]"></asp:SqlDataSource>
                     

						<a class="btn btn-lg btn-circle btn-outline-new-white" href="iletisim.aspx">REZERVASYON</a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-3 col-md-6">
					...
					<p><a href="#"> 1erkek1mutaf@gmail.com</a></p>
				</div>
				<div class="col-lg-3 col-md-6">
					<h3>Kayıt Ol</h3>
